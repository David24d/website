...
// Verificación de la existencia del parámetro txtID en la URL
if(isset($_GET['txtID'])){
    // Borrar el registro correspondiente en la tabla tbl_configuraciones utilizando el ID proporcionado
...
// Seleccionar todos los registros de la tabla tbl_configuraciones
