...
// Verificar si se ha enviado un formulario (GET) para editar un registro
if(isset($_GET['txtID'])){
...
// Verificar si se ha enviado un formulario POST para actualizar un registro
if($_POST){
    ...
    if($_FILES["imagen"]["tmp_name"]!=""){
     ...
     // Redireccionar a la página de índice con un mensaje
